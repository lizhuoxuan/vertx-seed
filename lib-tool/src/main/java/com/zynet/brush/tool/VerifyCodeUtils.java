...
public class VerifyCodeUtils {
    ...
    public static String outputImage2Base64(String code, int w, int h) throws IOException {
        ByteArrayOutputStream bos = new ByteArrayOutputStream();
        outputImage(w, h, bos, code);
        byte[] imageBytes = bos.toByteArray();
        return "data:image/jpg;base64," + Base64.getEncoder().encodeToString(imageBytes);
    }

    public static String outputImage2Base64(String code) throws IOException {
        ByteArrayOutputStream bos = new ByteArrayOutputStream();
